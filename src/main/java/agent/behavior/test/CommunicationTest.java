...
public class CommunicationTest extends Behavior {

    @Override
    public void communicate(AgentState agentState, AgentCommunication agentCommunication) {
        for (CellPerception cell:agentState.getPerception().getAllCells()) {
            if (cell.getAgentRepresentation().isPresent()) {
                agentCommunication.sendMessage(cell.getAgentRepresentation().get(), "Hello");
            }
        }
        for (var msg:agentCommunication.getMessages()) {
